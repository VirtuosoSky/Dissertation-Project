...
print('Do you want to add the constraint that sailors in double handed boats should be scheduled for duties at the same times ?')
print('Y/N ?')
x = input()
if x == 'Y':
    for e in all_e:
...
print('Do you want to add the constraint that sailors should only be allocated one duty in each series ?')
print('Y/N ?')
x = input()
if x == 'Y':
    for s in all_s:
...
print('Do you want to add the constraint that there has to be at least 3 races in between duties for each sailor ?')
print('Y/N ?')
x = input()
if x == 'Y':
    for s in all_s:
...
# Preferred duties
print('Do you want to add the constraint that sailors will not be allocated duties unless their preferred duties ?')
print('Y/N ?')
x = input()
if x == 'Y':
    for s in all_s:
